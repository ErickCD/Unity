...
public class createATorus : MonoBehaviour {
	...
	void Start () {
        ...
        for (int seg = 0; seg <= nbRadSeg; seg++)
        {
            ...
            for (int side = 0; side <= nbSides; side++){
                ...
                print("Angle = " + (-t1 * Mathf.Rad2Deg) + "\nEl vector de elevacion = " + Vector3.up);
                //print("El vector mul es: Mathf.Sin(t2) * radius2 (" + Mathf.Sin(t2) * radius2 + "), Mathf.Cos(t2) * radius2 (" + Mathf.Cos(t2) * radius2 + ")");
                //print("r2: " + r2);

                vertices[side + seg * (nbSides + 1)] = r1 + r2;
                //print("vertices[side(" + side + ") + seg(" + seg + ") * (nbSides(" + nbSides + ") + 1)]" + vertices[side + seg * (nbSides + 1)]);
                //print("====================================================");
            }
            //print("====================================================");
        }
